    ...
    list_my_team: async (Student_id, year_semester) => {
        try {
            const _list_my_team = await new Promise((resolve, reject) => {
                db.query(`SELECT DISTINCT A.Team_name, A.Team_id, C.Course_id, D.Course_name, A.max_member, A.current_member, C.finish_time
            ...
            if(_leave_team0){
                ...
                if(_leave_team2){
                    ...
                    if(_leave_team3){
                        ...
                        await this.delete_team(Team_id, _leave_team2);
                    }
                }
